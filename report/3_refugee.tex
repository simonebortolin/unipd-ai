...
To avoid that refugee families seeking shelter are assigned to countries randomly,  \citet{basshuysen,bansak_2018} proposed two machine learning-based algorithms for family placement that aims to optimize the overall employment rate of refugees. However, these methods ignore families’ preferences.
